  ...
  return (
    <AnimatePresence>
      <div 
        ...
        style={{ backdropFilter: "blur(4px)" }} // Blurnya dikurangi biar GPU ringan
      >
        <motion.div
        ...
        >
          ...
          <div className="flex gap-3">
            <button
              onClick={onClose}
              disabled={loadingAd}
              className="flex-1 py-3 rounded-2xl font-semibold text-sm bg-white/5 border border-white/10 text-white/40 active:scale-95 transition-transform disabled:opacity-20"
            >
              Cancel
            </button>
            <button
              ...
              disabled={loadingAd}
              className="flex-[2] py-3 rounded-2xl font-black text-sm active:scale-95 transition-all text-black border border-yellow-400/50"
              style={{
