...
export default function CosmicCoin({ onClick, locked, needsAd, children }: CosmicCoinProps) {
  ...
  // OPTIMASI: Generate partikel sekali saja di awal, bukan saat klik
  ...
  const coinVariants: Variants = {
    ...
    impact: {
      ...
      transition: { times: [0, 0.2, 1], duration: 1.2, ease: "easeInOut" }
    },
    ...
    <div className="relative flex items-center justify-center w-[260px] h-[260px]" style={{ perspective: "1000px" }}>
      <motion.button
        ...
        style={{
          ...
          backfaceVisibility: "hidden", // OPTIMASI: Mencegah flicker 3D
      ...
      <AnimatePresence>
        {(stage === "suction" || stage === "overload") && (
          <motion.div
            ...
            style={{ background: "radial-gradient(circle, #000000 15%, #150129 42%, #ffd700 74%, #ff1a00 90%, transparent 100%)", boxShadow: "0 0 50px 18px rgba(139, 92, 246, 0.55), inset 0 0 25px #000", transformStyle: "preserve-3d" }}
          >
