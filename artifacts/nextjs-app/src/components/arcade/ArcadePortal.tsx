  ...
  return (
    <div className="fixed inset-0 z-[100] bg-[#0d0b14]/90 flex flex-col items-center justify-center p-4 animate-in fade-in duration-300">
      ...
      <div className="w-full max-w-md h-[80vh] relative p-1 rounded-3xl overflow-hidden 
        ...
        <div className="w-full h-full rounded-[20px] bg-[#0d0b14] overflow-hidden relative">
          
          {/* Header Portal */}
          <div className="h-12 flex items-center justify-between px-4 bg-[#1a0b2e]/80 border-b border-[#D4AF37]/30">
            <span className="text-[10px] font-black text-[#D4AF37] tracking-widest uppercase">Cosmic Active</span>
            <button 
              onClick={onClose} 
              className="px-3 py-1 bg-[url('/images/mainmenu.jpg')] bg-cover rounded-lg text-[9px] font-black text-white uppercase border border-[#D4AF37]"
            >
              Close
            </button>
          </div>
