...
const SEGMENTS = [
  { label: "50 COINS", color: "#ef4444", textColor: "#fff" },
  { label: "150 COINS", color: "#3b82f6", textColor: "#fff" },
  { label: "300 COINS", color: "#a855f7", textColor: "#fff" },
  { label: "500 COINS", color: "#eab308", textColor: "#000" },
  { label: "1000 COINS", color: "#f97316", textColor: "#fff" },
  { label: "1 USDT", color: "#22c55e", textColor: "#fff" },
  { label: "5 USDT", color: "#ec4899", textColor: "#fff" },
  { label: "25 USDT", color: "#ffd700", textColor: "#000" },
  { label: "1 USDT", color: "#22c55e", textColor: "#fff" },
  { label: "1000 COINS", color: "#f97316", textColor: "#fff" },
  { label: "500 COINS", color: "#eab308", textColor: "#000" },
  { label: "300 COINS", color: "#a855f7", textColor: "#fff" },
...
const SPIN_ANIMATION_DURATION_MS = 3000;
...
export default function SpinPage() {
  const { coins, setCoins, usdtBalance, setUsdtBalance, playSFX } = useApp();
